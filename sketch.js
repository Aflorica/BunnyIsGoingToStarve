...
button2.mouseClicked(drop2)
  ...
  // air blower/ballon button for alex meow 
...
muteButton.position(420,30)
muteButton.size(50,50)
muteButton.mouseClicked(mute)
//making the 3 ropes
  
  rope = new Rope(7,{x:325,y:50});
  rope1 = new Rope(8,{x:45,y:30})
  rope2 = new Rope(4,{x:355,y:205})
